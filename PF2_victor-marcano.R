...
#1.3.1 Grafico 1, Dioxido de nitrogeno a lo largo de los aC1os-------------------
...
#1.3.2 grafico 2, Ozono a lo largo de los aC1os---------------------------------- 
...
#1.3.3 Grafico 3, problemas cardiacos de ciertos distritos para cada aC1o----------
...
#1.3.4 comparaciC3n de loa distritos con mayor muerte promedio ------------------
...
#1.3.5 comparaciC3n de los distritos con menor muerte promedio------------------
resultado %>% 
...
#1.3.6 comparacion entre distritos por muertes promedio en diferentes plazos de tiempo---------------------
...
#1.3.7 LC-nea de regresiC3n entre las muertes por afecciones cardiacas y el Ozono-------------
...
#1.3.8 LC-nea de regresiC3n entre las muertes por afecciones cardiacas y el Ozono-----------------------------------
